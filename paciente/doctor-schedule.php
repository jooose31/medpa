...
<title>::MedPa-Calendario del Doctor ::</title>
        ...
        <div class="user-info">
            ...
            <!--<div class="quick-stats">
                ...
                <ul>
                    ...
                    <li><span>0<i>Pendietes</i></span></li>
            ...
            <div role="tabpanel" class="tab-pane fade in active in active" id="skins">
                <ul class="demo-choose-skin">
                    ...
                    <li data-theme="deep-orange">
                        ...
                        <span>Anaranjado oscuro</span> </li>
                ...
                <div class="card m-t-15">
                    <div class="body">
                        <div class="tcol"> 
                            <!-- left side header-->
                            <div class="bg-white">
                                <button type="button" class="btn btn-raised btn-primary btn-sm" data-toggle="modal" href="#cal-new-event"> <i class="zmdi zmdi-plus"></i> Eventos</button>
                            </div>
                            <!-- /left side header --> 
                            
                            <!-- left side body -->
                            <div id="external-events">
                                <div class="event-name b-greensea"> Evento #1 <a class="pull-right text-muted event-remove"><i class="zmdi zmdi-delete"></i></a> </div>
                ...
                <div class="body">
                    <div class="row">
                        <div class="col-md-4 col-sm-3">
                            <h4 class="custom-font text-default m-0">Calendario</h4>
                        </div>
                        <div class="col-md-8 col-sm-9 text-right">
							<a href="https://google.com/calendar"> Calendario de Google </a>
                            <div class="btn-group">
                                <button class="btn btn-raised btn-success btn-sm mr-5" id="change-view-today">HOY</button>
                                ...
                                <button class="btn btn-raised btn-default btn-sm mr-5" id="change-view-month">MES</button>
                            </div>
                        </div>
                    </div>
                </div>
